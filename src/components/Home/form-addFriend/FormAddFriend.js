      ...
      <div className={` ${classes.viewFormAddFriend} ${isOpenForm}`}>
        ...
        <div className={classes.body}>
            ...
            <div className={classes.result}>
              {resultUser && (
                <div className={ `${classes.user} ${resultRequest === "Đã là bạn bè" ? classes.active_checkFriend : ""}`} >
                  <div className={classes.left}>
                    <div className={classes.avatar}>
                      <img src={tung} alt="tung" />
                    </div>
                    <p>{user.name}</p>
                  </div>
                  <div className={classes.right}>
                    <button onClick={addRequestHandler}>
                      {resultRequest}
                    </button>
                  </div>
                </div>
            ...
            <div className={classes.button}>
              ...
              <button className={classes.search} onClick = {searchHandler}>Tìm Kiếm</button>
            </div>
        </div>
      </div>
    </div>
